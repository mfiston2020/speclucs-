...
class PaymentsController extends Controller
{
    ...
    {
        $payments   =   \App\Models\Payment::where('company_id',Auth::user()->company_id)->get();
    ...
    public function add()
    {
        ...
        return view('seller.payments.add',compact('receipts','payment_methods'));
    }
    ...
    public function save(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                return redirect()->route('seller.payment')->with('successMsg','Receipt Successfully Paid');
            } catch (\Throwable $th) {
