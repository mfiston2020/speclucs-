...
class OrdersController extends Controller
{
    ...
    public function add()
    {
        ...
        return view('manager.myorder.create',compact('suppliers','lens_types','chromatics','coatings','index','order_number'));
    }
    ...
    public function placeOrder(Request $request)
    {
        ...
        try
        {
            ...
            $company        =   \App\Models\CompanyInformation::find($request->supplier);
            ...
            return redirect()->back()->withInput()->with('errorMsg','Something Went Wrong!');
        }
    }
    ...
    public function fetchSupplierProduct(Request $request)
    {
        ...
        if (initials($type->name)=='SV')
        {
            $product_id     =   \App\Models\Power::where('type_id',$type->id)
                            ...
                            ->where('eye','any')
                            ->where('company_id',$request->supplier)
