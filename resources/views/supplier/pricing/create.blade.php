    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('supplier.pricing.save')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        {{-- ====== input error message ========== --}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" name="lens_type">
                                                    <option value="">-- Select --</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="sphere_min" value="{{ old('sphere_min')}}" placeholder="MIN">
                                                </div>
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="sphere_max" value="{{ old('sphere_max')}}" placeholder="MAX">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="cylinder_min" value="{{ old('cylinder_min')}}" placeholder="MIN">
                                                </div>
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="cylinder_max" value="{{ old('cylinder_max')}}" placeholder="MAX">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="axis_min" value="{{ old('axis_min')}}" placeholder="MIN">
                                                </div>
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="axis_max" value="{{ old('axis_max')}}" placeholder="MAX">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="add_min" value="{{ old('add_min')}}" placeholder="MIN">
                                                </div>
                                                <div class=" col-md-4 col-sm-12">
                                                    <input type="number" class="form-control" name="add_max" value="{{ old('add_max')}}" placeholder="MAX">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="left" name="eye" value="left" class="custom-control-input" {{('eye'=='left')?'checked':''}}>
                                                    <label class="custom-control-label" for="left">Left</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="right" name="eye" value="right" class="custom-control-input" {{('eye'=='rght')?'checked':''}}>
                                                    <label class="custom-control-label" for="right">Right</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="both" name="eye" value="both" class="custom-control-input" {{('eye'=='both')?'checked':''}}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input type="text" class="form-control" name="lens_price" value="{{old('price')}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
