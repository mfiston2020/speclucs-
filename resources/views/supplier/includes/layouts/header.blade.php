            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="{{route('supplier.profile')}}"><i class="ti-user m-r-5 m-l-5"></i>
                            My Profile</a>
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"><a href="{{route('supplier.pricing.index')}}" class="sidebar-link"><i
                            class="mdi mdi-cash-multiple"></i><span class="hide-menu"> Tarrif </span></a>
                </li>

                <li class="sidebar-item"><a href="{{route('supplier.orders.index')}}" class="sidebar-link"><i
                            class="fas fa-shopping-cart"></i><span class="hide-menu"> Orders </span></a>
                </li>
            </ul>
        </nav>
