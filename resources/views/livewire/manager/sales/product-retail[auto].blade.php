                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <select class="form-control" wire:model.blur="lens_type">
                                        <option value="">
                                            *** Select Type ***
                                        </option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <label>Frames</label>
                                <div class="form-group">
                                    <select class="form-control custom-select" style="width: 100%; height:2rem;"  id="frame" wire:model.blur="frame">
                                        <option value="">
                                            *** Select Type ***
                                        </option>
                        ...
                        <div class="row">
                            <div class="col-12 row">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control custom-select" id="accessory" style="width: 100%; height:2rem;" wire:model.blur="accessory">
                                            <option value="">
                                                *** Select Product ***
                                            </option>
                                ...
                                <div class="d-flex flex-col items-center">
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <input type="text" min="0" max="100" class="form-control"
                                            ...
                                            wire:model.live="insurance_percentage_frame">
                                    </div>

                                    <div class="form-group col-2">
                                        <label>Ins Apprv</label>
                                        <input type="text" class="form-control" id="insurance_approved_frame"
                                            placeholder="approved Amt" wire:model.live="insurance_approved_frame">
                                    </div>

                                    <div class="form-group col-2">
                                        <label>Ins Payment</label>
                                        <input type="text" class="form-control" id="insurance_payment_frame"
                                            placeholder="Ins. payment" wire:model.blur="insurance_payment_frame"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-2">
                                        ...
                                        <input type="text" class="form-control" id="patient_payment_frame"
                                            placeholder="Pt. Payment" wire:model.live="patient_payment_frame" readonly>
                                    </div>
                                </div>
                            </div>
