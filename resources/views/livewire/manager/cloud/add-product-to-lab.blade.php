<div>
    @if (count($orders)>0)
        <div class="ml-1 row alert alert-warning alert-rounded col-lg-12 col-md-12 col-sm-12 d-flex align-content-center">
            <h4 class="card-title">You Have {{count((array_unique($countOrders)))}} Unprocessed orders from uploaded Products</h4>
            <hr>
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="#!" wire:loading.remove wire:target="processOrders" wire:click="processOrders" class="btn waves-effect waves-light btn-rounded btn-outline-primary" style="align-items: right;">
