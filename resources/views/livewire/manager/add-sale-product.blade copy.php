                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.blur="firstname" class="form-control" required="">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.blur="lastname" class="form-control" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Gender</label>
                                    <select class="form-control @error('gender') is-invalid @enderror custom-select" wire:model.blur='gender'>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" max="{{date('Y-m-d')}}" wire:model.blur="date_of_birth" class="form-control" required="">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.blur="tin_number" class="form-control" required="">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-4">
                            ...
                            @if ($lensProduct)
                                <input type="hidden" wire:model.live="productID">
                                    ...
                                    <label for="stock" class="text-right control-label col-form-label">
                                        ...
                                        <input type="text" wire:model.live="product_unit_price" class="form-control" readonly
                                            required>
                                    </div>
                                    ...
                                    <label for="stock"
                                        ...
                                        <input type="text" wire:model.live="product_stock" class="form-control" readonly
                                            required>
                                    </div>
                                @endif
                                    ...
                                    <label for="fstock" class=" text-right control-label col-form-label">Quantity
                                        ...
                                        <input type="number"
                                            ...
                                            wire:model.live.debounce.500ms="proquantity" min="1" max="{{$product_stock}}">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('prodiscount')  is-invalid @enderror"
                                            id="discount" placeholder="0" wire:model.live.debounce.500ms="prodiscount">
                                    ...
                                    <hr>
                                        ...
                                        @if (!$hide_insurance_details)
                                            <div class="col-sm-3">
                                                ...
                                                id="insurance_percentage" max="100" min="0"  placeholder="0" wire:model.live.debounce.500ms="insurance_percentage">
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                id="insurance_number"  wire:model.live.debounce.500ms="insurance_number">
                                            </div>
                                            ...
                                            <label for="cost" class="text-right control-label col-form-label invalid">
                                                ...
                                                id="approved_amount" min="0"  placeholder="0" wire:model.live.debounce.500ms="approved_amount">
                                            </div>
                                        </div>
                            ...
                            <div class="card" id="non-lens">
                                ...
                                <div class="form-group row">
                                    <label for="stock" class="col-sm-3 text-right control-label col-form-label">Unit
                                        Price</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" placeholder="0" wire:model.live="product_unit_price"
                                            readonly required>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control @error('proquantity') is-invalid @enderror"
                                                wire:model.live.debounce.500ms="proquantity"
                                ...
                                <div class="form-group row">
                                    <label for="cost" class="col-sm-3 text-right control-label col-form-label invalid">Total
                                        Amount</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" wire:model.live="product_total_amount"
                                    ...
                                    <hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" class="form-control @error('insurance_percentage')  is-invalid @enderror"
                                                id="insurance_percentage" max="100" min="0"  placeholder="0" wire:model.live.debounce.500ms="insurance_percentage" required>
                                            </div>
                                        </div>
