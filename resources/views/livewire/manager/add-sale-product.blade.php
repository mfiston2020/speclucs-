                            ...
                            @if ($customerType == 'existing' && $myCustomers && $singleExistingCustomer)
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input type="text" value="{{ $singleExistingCustomer->name }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" value="{{ $singleExistingCustomer->email }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Phone Number</label>
                                            <input type="text" value="{{ $singleExistingCustomer->phone }}"
                                                class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card col-md-6 col-sm-12">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <span class="mt-1 mr-3 text-danger" x-data="{ show: false }"
                                                    x-init="@this.on('product-not-found', () => {
                                                ...
                                                <button type="button"
                                                    class="btn btn-warning waves-effect float-right"
                                                    wire:click="searchPrice(0)">
                                                    Search Product
                                                    <img wire:loading wire:target="searchPrice"
                                                        src="{{ asset('dashboard/assets/images/loading2.gif') }}"
                                                        width="20" alt="">
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12 col-md-2">
                                                    <label for="fstock"
                                                        class=" text-right control-label col-form-label">Quantity
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    <label for="discount"
                                                        class="text-right control-label col-form-label invalid">
                                                        Price Adj.
                                                    </label>
                                                    <input type="text"
                                                        ...
                                                        @if (count($allInsurances) > 0)
                                                            ...
                                                            @foreach ($allInsurances as $insurance)
                                                                <option value="{{ $insurance->id }}">
                                                                    {{ $insurance->insurance_name }}</option>
                                                            @endforeach
                    ...
                    @foreach ($invoiceProduct as $product)
                        <div class="todo-item all-todo-list p-3 border-bottom position-relative">
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    <?php
                                    $prod = \App\Models\Product::where(['id' => $product->product_id])
                                    ...
                                    <div class="form-check d-flex justify-content-between">
                                        ...
                                        <div>
                                            <button wire:click="removeProduct({{ $product->id }})"
                                                class="btn btn-link text-dark p-1 text-decoration-none">
                                    ...
                                    <div class="form-check d-flex justify-content-between">
                                        <div>
                                            <div class="content-todo ms-3">
                                                <h5 class="font-medium fs-4 todo-header mb-0"
                                                    data-todo-header="Meeting with Mr.Jojo Sukla at 5.00PM">
                                                    {{ initials($type)=='BT'?'Bifocal Round Top':initials($type) . ' ' . $index . ' ' . $chromatics . ' ' . $coating }}
                                                    <span class="text-warning">[{{ $product->quantity }}]</span>
                                                </h5>
                                                <span class="todo-time fs-2 text-muted d-flex align-items-center">
                                                    {{-- <small class="text-muted">
                                        ...
                                        <div>
                                            <button wire:click="removeUnavailableProduct({{ $product->id }})"
                                                class="btn btn-link text-dark p-1 text-decoration-none">
                                                <i class="fa fa-times"></i>
                                            </button>
                                        </div>
...
<div id="product-not-found-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-exclamation-triangle"></i>
                    {{ __('manager/sales.product_not_found') }}</h4>
            ...
            <div class="modal-footer">
                <button class="btn btn-info waves-effect" wire:click="addUnavailableProducts">
                    ...
                    <span wire:loading wire:target='addUnavailableProducts'>
                        <img src="{{ asset('dashboard/assets/images/loading2.gif') }}" height="20"
                            alt="">{{ __('manager/sales.request_processing') }}
                    </span>
                </button>
