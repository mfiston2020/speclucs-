...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <h4 class="card-title">All Requested In Production</h4>
                        </div>
                        {{-- ============================== --}}
        ...
        <div class="tab-content br-n pn">
            {{-- In production --}}
            <div class="row">
                <form action="{{route('manager.sent.request.to.complete')}}" id="productionForm" method="post" class="col-12">
                    @csrf
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="tab-content br-n pn">
                                    ...
                                    <div id="internal-orders" class="tab-pane active">
                                                            ...
                                                            <td>
                                                                <div class="form-check form-check-inline align-content-center">
                                                                    <input class="form-check-input allCheckbox" type="checkbox"
                                                                        name="invoiceId[]" id="inlineCheckbox1" value="{{$request->id}}">
                                                                </div>
                                                            </td>
                                                            <td>{{ $key + 1 }}</td>
                                                            <td>
                                    ...
                                    <div id="external-orders" class="tab-pane">
                                        <div class="table-responsive mt-4">
                                            <table id="zero_config" class="table table-striped table-bordered nowrap"
                                                style="width:100%">
                                                <thead>
                                ...
                                <hr>
                                <button onclick="document.getElementById('productionForm').submit()" class="btn btn-success btn-rounded">
                                    <i class="mdi mdi-basket"></i> Complete Selected Orders
                                </button>
                            </div>
                        </div>
                    </div>
