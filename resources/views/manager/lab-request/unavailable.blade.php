    ...
    <div class="tab-content">
        ...
        <div class="card">
            ...
            <div class="tab-content br-n pn">
                ...
                <div class="tab-pane active" id="incomplete-orders" role="tabpanel">
                                                                                ...
                                                                                @if (!$request->unavailableproducts->isEmpty())
                                                                                    @foreach ($request->unavailableproducts as $productsold)
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                {{ initials($productsold->type->name)=='BT'?'Bifocal Round Top':initials($productsold->type->name) }}
                                                                                                {{ $productsold->uchromatic->name }}
                                                                                                {{ $productsold->coating->name }}
                                                                                                {{ $productsold->uindex->name }}
                                                                                            </td>
                                                                                            <td>
                ...
                <div class="tab-pane" id="external-booking-orders" role="tabpanel">
