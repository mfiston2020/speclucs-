                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills mt-4 mb-4">
                            <li class=" nav-item">
                                <a href="#internal_priced" class="nav-link active" data-toggle="tab"
                                    aria-expanded="false">
                                    Internal Priced(s)
                            ...
                            <li class="ml-3 nav-item">
                                <a href="#external_priced" class="nav-link" data-toggle="tab"
                                    aria-expanded="false">
                                    External priced(s)
                                    <span class="badge badge-danger badge-pill ml-2">
                        ...
                        <div class="tab-content br-n pn">
                            ...
                            <div id="internal_priced" class="tab-pane active">
                                {{-- <div> --}}
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                            ...
                            <div id="external_priced" class="tab-pane">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
