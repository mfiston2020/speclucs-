...
<div class="container-fluid">
                    ...
                    <ul class="nav nav-pills mt-4 mb-4">
                        ...
                        <li class="nav-item">
                            <a href="#external-booking-orders" class="nav-link" data-toggle="tab" aria-expanded="false">
                                External Booking(s)
                                <span class="badge badge-danger badge-pill">{{number_format(count($requests_priced_out))}}</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="" role="tabpanel">
            <div class="tab-pane  p-20" id="external-booking-orders" role="tabpanel">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                @if (count($requests_priced_out)<=0) <div
                                    class="alert alert-warning alert-rounded col-lg-7 col-md-9 col-sm-12">
                                    <b>Warning! </b> Nothing to show here
                            </div>
                            @else
