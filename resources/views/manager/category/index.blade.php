            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <a href="{{route('manager.category.create')}}" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-primary" style="align-items: right;">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="{{route('manager.category.delete',Crypt::encrypt($category->id))}}"
