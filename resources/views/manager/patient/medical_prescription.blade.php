                                                ...
                                                <table id="zero_config" class="table table-striped table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="border-top-0 font-weight-bold border-left-0 border-right-0">Total Dosage</th>
                                                            <th class="border-top-0 font-weight-bold border-left-0 border-right-0">Duration</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($medical_prescription as $key=> $item)
                                                            <tr>
