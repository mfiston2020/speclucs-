                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        @if ($invoice->status=='completed')
                            ...
                            class="pull-right btn btn-outline-warning"><i class="fa fa-print"></i> Print Invoice</a>
                        ...
                        <table class="table stylish-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <span hidden>{{$prod=\App\Models\Product::where(['id'=>$product->product_id])->where('company_id',Auth::user()->company_id)->select('*')->first()}}</span>
                                        <span
                                    ...
                                    @else
                                    <td>
                                        <a href="{{route('manager.sales.edit.product',Crypt::encrypt($product->id))}}" style="color: rgb(0, 38, 255)">Edit</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="myModal" class="modal fade" tabindex="-1" role="dialog"
                        aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{route('manager.sales.finalize',Crypt::encrypt($invoice->id))}}" method="post">
                                @csrf
                            <div class="modal-content">
                            ...
                            value={{\App\Models\SoldProduct::where(['invoice_id'=>$invoice->id])->where('company_id',Auth::user()->company_id)->select('*')->sum('total_amount')}}>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{$invoice->client_name}}" class="form-control" placeholder=""
                                            name="name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="{{$invoice->phone}}" class="form-control" placeholder="" name="phone">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tin_number" class="col-sm-3 text-right control-label col-form-label">Client TIN Number</label>
                                        <div class="col-sm-9">
                                            <input type="text" value="{{$invoice->tin_number}}" class="form-control" placeholder="" name="tin_number"
                                                >
                                        </div>
                                    </div>
                                    @endif
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-info waves-effect">Complete sale</button>
                                    <button type="button" class="btn btn-danger waves-effect"
                                        data-dismiss="modal">No</button>
                                </div>
                            </div>
