                ...
                <div id="search_results" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{route('manager.sales.save')}}">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="discount"
                                            class="col-sm-4 text-right control-label col-form-label invalid">Discount</label>
                                        <div class="col-sm-8">
...
<script>
    ...
    $('#quantity2').on('input', function ()
    {
        ...
        var total = $("#total_amount2").val((qty * up) - dsct);
    });
