...
@section('title','Manager Dashboard - Orders In Production')
...
<div class="container-fluid">
    ...
    {{-- ================================== --}}
    <div class="row">
        <form action="{{route('manager.received.order.completed')}}" method="post" class="col-12">
            @csrf
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <h4 class="card-title">
                                ...
                                <button type="submit" class="btn btn-success btn-rounded"><i class="mdi mdi-basket"></i> Complete Selected Orders</button>
                            </h4>
                        </div>
                    </div>
                </div>
