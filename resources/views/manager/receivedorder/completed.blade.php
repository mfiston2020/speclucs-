...
@section('title','Manager Dashboard - Orders Completed')
...
<div class="container-fluid">
    ...
    {{-- ================================== --}}
    <div class="row">
        <form action="{{route('manager.received.order.delivery')}}" method="post" class="col-12">
            @csrf
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <h4 class="card-title">
                                ...
                                <button type="submit" class="btn btn-success btn-rounded"><i class="mdi mdi-truck-delivery"></i> Delivery</button>
                            </h4>
                        </div>
                    </div>
                </div>
