                    ...
                    <div class="card-body">
                        <div class="row">
                            <h4 class="card-title">
                                ...
                                <a href="{{ route('manager.received.order.incomplete') }}"
                                    class="btn btn-primary btn-rounded"><i class="mdi mdi-cart-plus"></i> Completed
                                    Orders</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row m-t-10">
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-3">
                                <div class="d-flex align-items-center">
                                    <div class="m-r-10"><span class="text-orange display-5"><i
                                                class="mdi mdi-factory"></i></span></div>
                                    <div><span class="text-muted">In Production</span>
                                        <h3 class="font-medium m-b-0">{{ $orders_production }}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div><span class="text-muted">Completed Orders</span>
                                        <h3 class="font-medium m-b-0">{{ $orders_completed }}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-3">
                                <div class="d-flex align-items-center">
                                    <div class="m-r-10"><span class="display-5"><i
                                                class="mdi mdi-truck-delivery"></i></span></div>
                                    <div><span class="text-muted">In Delivery</span>
                                        <h3 class="font-medium m-b-0">{{ $orders_delivery }}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-3">
                                <div class="d-flex align-items-center">
                                    <div class="m-r-10"><span class="display-5"><i
                                                class="mdi mdi-package-variant"></i></span></div>
                                    <div><span class="text-muted">Received</span>
                                        <h3 class="font-medium m-b-0">{{ $orders_received }}</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- col -->
