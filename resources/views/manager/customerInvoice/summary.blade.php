                                ...
                                <tbody>
                                    ...
                                    @foreach ($invoices as $invoice)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('manager.statementInvoice.details',Crypt::encrypt($invoice->id))}}">
                                            ...
                                            <td>
                                                <a href="{{ route('manager.statementInvoice.details',Crypt::encrypt($invoice->id))}}">More Details >></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
