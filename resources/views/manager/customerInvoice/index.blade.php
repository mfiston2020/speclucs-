    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('manager.cutomerInvoice.search')}}" method="GET">
                    <div class="form-body">
                        <div class="card-body">
                            <div class=" p-t-20">
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="m-b-0 text-white">Invoice Summary</h4>
                </div>
                <form class="form-horizontal" action="{{route('manager.statementInvoice.summary')}}" method="GET">
                    <div class="form-body">
                        <div class="card-body">
                            <div class=" p-t-20">
                                <div class="form-group row">
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="card">
                ...
                <form action="{{route('manager.statementInvoice.search')}}" method="GET">
                    <div class="form-body">
                        <div class="card-body">
                            <div class="p-t-20">
                                <div class="form-group row">
