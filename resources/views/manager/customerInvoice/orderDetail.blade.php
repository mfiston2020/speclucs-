                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <span
                                        hidden>{{$order=\App\Models\Invoice::where(['id'=>$item->invoice_id])->select('*')->first()}}</span>
                                    <span
                                        hidden>{{$statement=\App\Models\InvoiceStatement::where('id',$order->statement_id)->select('*')->first()}}</span>
                                    <span
                                        hidden>{{$product=\App\Models\Product::where('id',$item->product_id)->where('company_id',Auth::user()->company_id)->select('*')->first()}}</span>
                                    <span
                                    ...
                                    <td>
                                        <span
                                            class="text-{{($statement->status=='invoiced')?'warning':'success'}}">{{$statement->status}}</span>
                                    </td>
