...
@section('title','Admin Dashboard - Edit Suppliers')
...
{{-- ==== Breadcumb ======== --}}
@section('page_name','Edit Suppliers')
@section('current','Edit Suppliers')
{{-- === End of breadcumb == --}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('manager.supplier.update')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        {{-- ====== input error message ========== --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sname" placeholder="Suppliers Name"
                                    name="suppliers_name" value="{{$supplier->name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sdescription" placeholder="Suppliers description"
                                    name="suppliers_description" value="{{$supplier->description}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="semail" placeholder="Suppliers email"
                                    name="suppliers_email" value="{{$supplier->email}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sphone" placeholder="Suppliers phone"
                                    name="suppliers_phone" value="{{$supplier->phone}}">
                            </div>
                        </div>
                    </div>
                    <hr>
