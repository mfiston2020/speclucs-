        ...
        <div class="container bootstrap snippets bootdey">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="invoice-wrapper">
                        <div class="intro">
                            ...
                            This is the invoice for a payment of <strong
                                style="color: red">{{format_money($tot)}}</strong> to be paid
                        </div>
                        ...
                        <div class="line-items">
                            ...
                            <div class="items">
                                ...
                                <div class="row item">
                                    ...
                                    <div class="col-xs-3 desc">
                                        Invoice #{{sprintf('%04d',$invoice->reference_number)}}
                                    </div>
                                    <div class="col-xs-3 qty">

                                        <span
                                            hidden>{{$products=count(\App\Models\SoldProduct::where(['invoice_id'=>$invoice->id])->where('company_id',Auth::user()->company_id)->select('product_id')->get())}}</span>
                                    </div>
                            ...
                            <div class="total text-right">
                                ...
                                <div class="field">
                                    Subtotal <span>{{format_money($total)}}</span>
                                </div>
                                <div class="field">
                                    vat <span>0%</span>
                                </div>
                                <div class="field grand-total">
                                    Total <span>{{format_money($total)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="footer">
                        Copyright © {{date('Y')}}. {{$company->company_name}}
                    </div>
                    <br>
                </div>
            </div>
