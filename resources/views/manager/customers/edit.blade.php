    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('manager.client.update',Crypt::encrypt($detail->id))}}" method="POST">
                    @csrf
                    <div class="card-body">
                        {{-- ====== input error message ========== --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" placeholder="Fiston MUNYAMPETA"
                                    name="name" min="1" autocomplete="off" value="{{$detail->name}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="email" placeholder="email"
                                    name="email" min="1" autocomplete="off" value="{{$detail->email}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="phone" placeholder="phone"
                                    name="phone" min="1" autocomplete="off" required value="{{$detail->phone}}">
                            </div>
                        </div>
