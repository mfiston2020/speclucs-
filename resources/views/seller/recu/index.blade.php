            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <a href="{{route('seller.receipt.add')}}" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-primary" style="align-items: right;">
                            ...
                            <tbody>
                                @foreach ($receipts as $key=> $receipt)
                                    <tr>
                                        ...
                                        <td><a href="{{route('seller.receipt.detail',Crypt::encrypt($receipt->id))}}">{{$receipt->title}}</a> </td>
                                        ...
                                        <td>
                                            <a href="{{route('seller.receipt.detail',Crypt::encrypt($receipt->id))}}" style="color: blue">edit</a>
