...
<div class="container-fluid">
    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select" name="lens_type" id="lens_type" required>
                                            <option value="">-- Select --</option>
                ...
                <div id="search_results" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{route('seller.receipt.save.product')}}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group m-b-0 text-center">
                        <img src="{{ asset('dashboard/assets/images/loading.gif')}}" alt="" height="50px" width="50px"
                            id="loading">
                        <button type="submit" class="btn btn-info waves-effect waves-light text-white" form="searchForm">Search</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card" id="non-lens">
            ...
            <br>
            <form class="form-horizontal" action="{{route('seller.receipt.save.product')}}" method="POST">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="cost" id="cost2" value="{{old('cost')}}">
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <div class="card" id="productPrompt">
            ...
            <br>
            <form class="form-horizontal" action="{{route('seller.receipt.new.product')}}" method="POST">
                @csrf
                <div class="card-body">
