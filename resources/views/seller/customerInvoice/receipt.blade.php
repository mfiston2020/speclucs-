    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body printableArea">
                <h3><b>INVOICE</b> <span class="pull-right">#{{sprintf('%04d',$invoice->invoice_number)}}</span></h3>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-left">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"> {{format_money($unit_price=$product['unit_price'])}} </td>
                                        <td class="text-right"> {{format_money($quantity*$unit_price)}} </td>
                                    </tr>
                                    @endforeach
                    ...
                    <div class="col-md-12">
                        <div class="pull-right m-t-30 text-right">
                            ...
                            <p>Total amount: {{format_money($invoice->total_amount-$invoice->due)}}</p>
                            <p>Total paid: {{format_money($invoice->total_amount)}}</p>
