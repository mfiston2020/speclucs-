            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <a href="{{route('seller.income.add')}}" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-primary" style="align-items: right;">
                            ...
                            <tbody>
                                @foreach ($income as $key=> $income)
                                    <tr>
                                        ...
                                        <td>{{$income->title}}</td>
                                        <td>
                                            <a href="#">{{\App\Models\PaymentMethod::where(['id'=>$income->payment_method_id])->where('company_id',Auth::user()->company_id)->pluck('name')->first()}}</a>
                                        </td>
