...
@section('title','seller- Add Income')
...
{{-- ==== Breadcumb ======== --}}
@section('page_name','New Income')
@section('current','Add Income')
{{-- === End of breadcumb == --}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('seller.income.save')}}" method="POST">
                    @csrf
                    <div class="card-body">
                {{-- ====== input error message ========== --}}
                ...
                {{-- ====================================== --}}
                        <div class="form-group row">
                            <label for="pname"
                                class="col-sm-3 text-right control-label col-form-label">Income Name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control"
                                    placeholder="income Name Here" name="income_name" value="{{old('income_name')}}">
                            </div>
                        </div>
