...
@section('title','Seller - Select Customer')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('seller.sales.customer')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        {{-- ====== input error message ========== --}}
                        ...
                        <div class="form-group row">
                            <label for="customer" class="col-sm-3 text-right control-label col-form-label">
                                Reference Number
                                </label>
                            <div class="col-sm-9">
