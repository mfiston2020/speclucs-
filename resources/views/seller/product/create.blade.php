...
<div class="container-fluid">
    <form class="form-horizontal" action="{{route('seller.product.save')}}" method="POST">
        @csrf
        <div class="row">
            ...
            <div class="col-md-12" id="non-lens">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="cost" class="col-sm-3 text-right control-label col-form-label invalid">Cost</label>
                            <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-success" type="button" onclick="education_fields();"><i
                                                class="fa fa-plus"></i> Add Field</button>
                                            </div>
                                    </div>
                                </div>
                            </div>
