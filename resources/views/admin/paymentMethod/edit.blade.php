...
@section('title','Admin Dashboard - Edit Payment Method')
...
{{-- ==== Breadcumb ======== --}}
@section('page_name','Edit Payment Method')
@section('current','Edit Payment Method')
{{-- === End of breadcumb == --}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form class="form-horizontal" action="{{route('admin.paymentMethods.update',Crypt::encrypt($payment_methods->id))}}" method="POST">
                    @csrf
                    <div class="card-body">
                        {{-- ====== input error message ========== --}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="" placeholder=" Name"
                                    name="name" value="{{$payment_methods->name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="sdescription" placeholder="description"
                                    name="description" value="{{$payment_methods->description}}">
                            </div>
                        </div>
                    </div>
                    <hr>
