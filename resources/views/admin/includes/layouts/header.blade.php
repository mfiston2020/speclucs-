    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-right">
                ...
                <!-- ============================================================== -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="{{route('manager.profile')}}"
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span
                        ...
                        <li class="sidebar-item"><a href="{{route('admin')}}" class="sidebar-link"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu"> Dashboard </span></a>
                        </li>

                        <li class="sidebar-item"><a href="{{route('admin.companies')}}" class="sidebar-link"><i
                                    class="mdi mdi-view-dashboard"></i><span class="hide-menu"> Company </span></a>
                        </li>

                        <li class="sidebar-item"><a href="{{route('admin.paymentMethods')}}" class="sidebar-link"><i
                                    class="mdi mdi-cash-multiple"></i><span class="hide-menu"> Payment Methods </span></a>
                        </li>

                        <li class="sidebar-item"><a href="{{route('admin.productSettings')}}" class="sidebar-link"><i
                                    class="mdi mdi-settings"></i><span class="hide-menu"> Product Settings </span></a>
                        </li>

                        <li class="sidebar-item">
                            <a href="{{route('admin.users.roles')}}" class="sidebar-link">
